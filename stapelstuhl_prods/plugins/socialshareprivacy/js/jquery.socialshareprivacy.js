    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/plugins/socialshareprivacy/images/dummy_facebook.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'action'            : 'recommend',
                    'layout'            : 'button_count',
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : '/plugins/socialshareprivacy/images/dummy_facebook_share_de.png',
                        'img'           : '/plugins/socialshareprivacy/images/dummy_facebook_share_active_de.png'
                    }
                },
                'twitter' : {
                    'status'            : 'on',
                    'dummy_img'         : '/plugins/socialshareprivacy/images/dummy_twitter.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/plugins/socialshareprivacy/images/dummy_gplus.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'size'              : 'medium'
                }
            ...
            .then( function() {
                ...
                if (facebook_on) {
                    ...
                    if (facebook_sharer_on) {
                        ...
                        fb_code = '<iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FStapelstuhlDiscount24%2Fapp_1435562480042734%3Fref%3Dhl&amp;width&amp;layout=button&amp;action=like&amp;show_faces=false&amp;share=true&amp;height=35&amp;appId=1435562480042734" scrolling="no" frameborder="0" style="position: absolute; border:none; min-width:150px; margin: 0 0 0 0px; padding:0px 0 0 10px; overflow:hidden; height:35px;" allowTransparency="true"></iframe>';
                    }
				...
				// deaktiviert da sich bei klick des Infos icons infos direkt einblenden sollen	
				   context.append('<li class="settings_info ' + options.perma_orientation + '"><div class="settings_info_menu off perma_option_off"><div id="disclaimer"> <span class="help_info icon"><span class="info">' + language.txt_help + '</span></span></div></div></li>');
